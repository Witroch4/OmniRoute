...
export const CLAUDE_CODE_COMPATIBLE_VERSION = getClaudeCodeClientVersion();
export const CLAUDE_CODE_COMPATIBLE_USER_AGENT = `claude-cli/${CLAUDE_CODE_COMPATIBLE_VERSION} (external, sdk-cli)`;
