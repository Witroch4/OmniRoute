...
export interface InjectBillingHeaderOp {
  ...
  /** Override the embedded `cc_version=` value. Defaults to the canonical pinned CLI version. */
  version?: string;
}
...
export const DEFAULT_CLAUDE_CODE_VERSION = getClaudeCodeClientVersion();
